...
export namespace faces {
  ...
  void draw_ceiling(voo::memiter<vtx> & m, int x, int y, float c) {
    float x0 = x;
    float x1 = x + 1;
    float y0 = y;
    float y1 = y + 1;
  ...
  void draw_floor(voo::memiter<vtx> & m, int x, int y, float f) {
    float x0 = x;
    float x1 = x + 1;
    float y0 = y;
    float y1 = y + 1;
  ...
  void draw_x_wall(voo::memiter<vtx> & m, float x0, float x1, float y, float f, float c) {
  ...
  void draw_y_wall(voo::memiter<vtx> & m, float x, float y0, float y1, float f, float c) {
